...
export default function RegisterCitizenScreen({ navigation }: Props) {
  ...
  const checkAge = () => {
    if (!dob) {
      setAgeError('Please select a date of birth.')
      return
    }
    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: T.bg }} edges={['top']}>
      ...
      >
        <ScreenHeader
          ...
          sub="Village Enumeration · 18+ Only"
        ...
        {step === 1 && (
          ...
          >
            ...
            <Text style={{ fontSize: 12, color: T.textSub, marginBottom: 16, lineHeight: 18 }}>
              Enter the citizen's date of birth. The system will verify they are 18 or older before
              proceeding.
            </Text>
            ...
            <View style={{ marginBottom: 16 }}>
              ...
              >
                <Text style={{ color: dob ? T.text : T.textDim, fontSize: 14 }}>
              ...
              {!!dob && (
                <Text style={{ fontSize: 12, color: T.textSub, marginTop: 6 }}>
                  Age:{' '}
                  <Text
                    style={{ fontWeight: '800', color: calcAge(dob) >= 18 ? TZ.green : '#dc2626' }}
                  >
        ...
        {step === 2 && (
          ...
          >
            ...
            >
              ...
              <Text style={{ fontSize: 12, color: TZ.green, fontWeight: '600' }}>
                Age verified: {calcAge(dob)} years old · DOB: {dob}
              </Text>
            </View>

            <Text style={{ fontSize: 16, fontWeight: '800', color: T.text, marginBottom: 16 }}>
              Personal Details
            </Text>
            <SField
              label="First Name"
            ...
            <View style={{ marginBottom: 14 }}>
              <Text style={{ fontSize: 12, fontWeight: '600', color: T.textSub, marginBottom: 8 }}>
                Gender *
              </Text>
                ...
                {(['male', 'female'] as const).map((g) => (
                  <TouchableOpacity
                    ...
                    style={{
                      ...
                      borderWidth: 1.5,
                      paddingVertical: 12,
                      borderColor: gender === g ? TZ.blue : T.border,
                      backgroundColor: gender === g ? `${TZ.blue}25` : T.card2,
                    }}
                  >
                    ...
                    <Text
                      style={{
                        fontSize: 13,
                        fontWeight: '600',
                        color: gender === g ? TZ.blue : T.textSub,
                      }}
                    >
                      {g.toUpperCase()}
                    </Text>
                ...
                {['A+', 'A-', 'B+', 'B-', 'AB+', 'AB-', 'O+', 'O-', 'Unknown'].map((bg) => (
                  <TouchableOpacity
                    ...
                    style={{
                      ...
                      paddingVertical: 6,
                      borderColor: bloodGroup === bg ? TZ.blue : T.border,
                      backgroundColor: bloodGroup === bg ? `${TZ.blue}20` : T.card,
                    }}
                  >
                    <Text style={{ fontSize: 11, color: bloodGroup === bg ? TZ.blue : T.textSub }}>
                      {bg}
                    </Text>
                  </TouchableOpacity>
                ))}
        ...
        {step === 3 && (
          ...
          >
            ...
            <Text style={{ fontSize: 22, fontWeight: '900', color: T.text, marginBottom: 6 }}>
              Citizen Registered!
            </Text>
            ...
            >
              <Text style={{ color: T.textSub, fontWeight: '700', fontSize: 14 }}>
                Back to Dashboard
              </Text>
            </TouchableOpacity>
          </ScrollView>
