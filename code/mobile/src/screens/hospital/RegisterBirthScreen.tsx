                ...
                {Array.from({ length: daysIn }, (_, i) => i + 1).map((d) => (
                  <TouchableOpacity
                    ...
                    style={{
                      ...
                      borderRadius: 8,
                      marginVertical: 2,
                      backgroundColor: d === day ? `${H.primary}30` : 'transparent',
                    }}
                  >
                    <Text
                      style={{
                        fontSize: 13,
                        color: d === day ? H.primaryL : T.textSub,
                ...
                {MONTHS.map((name, i) => (
                  <TouchableOpacity
                    ...
                    style={{
                      ...
                      borderRadius: 8,
                      marginVertical: 2,
                      backgroundColor: i + 1 === mo ? `${H.primary}30` : 'transparent',
                    }}
                  >
                    <Text
                      style={{
                        fontSize: 13,
                        color: i + 1 === mo ? H.primaryL : T.textSub,
                ...
                {Array.from({ length: curY - 1999 + 1 }, (_, i) => curY - i).map((y) => (
                  <TouchableOpacity
                    ...
                    style={{
                      ...
                      borderRadius: 8,
                      marginVertical: 2,
                      backgroundColor: y === yr ? `${H.primary}30` : 'transparent',
                    }}
                  >
                    <Text
                      style={{
                        fontSize: 13,
                        color: y === yr ? H.primaryL : T.textSub,
...
function SuccessModal({
  ...
  const childName = [birth.childFirstName, birth.childMiddleName, birth.childSurname]
    .filter(Boolean)
    .join(' ')
    .toUpperCase()
        ...
        >
          ...
          >
            ...
            <Text style={{ fontSize: 12, color: 'rgba(255,255,255,0.65)', textAlign: 'center' }}>
              {birth.synced === 1
                ? 'Record successfully added to NBS Central Database'
                : 'Saved on this device — will sync to the NBS Central Database automatically once online'}
            </Text>
          </LinearGradient>

          <View style={{ padding: 20, gap: 12 }}>
            <Text style={{ fontSize: 18, fontWeight: '900', color: T.text, textAlign: 'center' }}>
              {childName}
            </Text>
            <Text style={{ fontSize: 12, color: T.textSub, textAlign: 'center', marginTop: -6 }}>
              New Citizen of Tanzania
            </Text>
            ...
            <View style={{ gap: 6 }}>
              ...
              >
                ...
                <TouchableOpacity
                  onPress={() => copy(birth.birthId, 'Birth Registration ID')}
                  style={{ padding: 4 }}
                >
              ...
              <Text style={{ fontSize: 10, color: T.textDim, fontStyle: 'italic' }}>
                Keep this ID safe — required at age 18 when the child registers with a Village
                Officer to obtain their National ID (NIN)
              </Text>
            </View>
            ...
            <View style={{ gap: 6 }}>
              ...
              >
                ...
                <TouchableOpacity
                  onPress={() => copy(birth.certNo, 'Certificate number')}
                  style={{ padding: 4 }}
                >
            ...
            >
              ...
              <Text style={{ fontSize: 10, color: T.textSub, flex: 1 }}>
                Certificate synced to internal registry · QR signed by Govt PKI
              </Text>
            </View>
            ...
            <TouchableOpacity
              ...
              style={{
                ...
                justifyContent: 'center',
                gap: 8,
                backgroundColor: downloading ? T.card2 : TZ.green,
                borderRadius: 12,
                paddingVertical: 13,
                borderWidth: downloading ? 1 : 0,
                borderColor: T.border,
              }}
              activeOpacity={0.85}
            >
              {downloading ? (
                <ActivityIndicator color={TZ.green} size="small" />
              ) : (
                <Download size={16} color="#fff" />
              )}
              <Text
                style={{ fontSize: 14, fontWeight: '800', color: downloading ? TZ.green : '#fff' }}
              >
        ...
        <View style={{ flex: 1 }}>
          ...
          <View
            style={{
              ...
              borderWidth: 1,
              borderColor: `${TZ.green}50`,
              backgroundColor: `${TZ.green}20`,
              paddingHorizontal: 8,
              paddingVertical: 3,
            }}
          >
            <View style={{ width: 5, height: 5, borderRadius: 2.5, backgroundColor: TZ.green }} />
            <Text style={{ fontSize: 8, fontWeight: '700', color: TZ.green }}>
              ALIVE · VERIFIED
            </Text>
          </View>
        </View>
...
export default function RegisterBirthScreen({ navigation }: Props) {
  ...
  const lookupParent = useCallback(async (nid: string, role: 'father' | 'mother') => {
    ...
    if (isFather && found.gender !== 'MALE') {
      setError('This NID belongs to a female citizen.')
      setLoading(false)
      return
    }
    if (!isFather && found.gender !== 'FEMALE') {
      setError('This NID belongs to a male citizen.')
      setLoading(false)
      return
    }
    setData(found)
  ...
  const handleSubmit = useCallback(async () => {
    ...
    try {
      ...
      const fatherName = fatherData
        ? `${fatherData.firstName} ${fatherData.middleName ?? ''} ${fatherData.surname}`
            .replace(/\s+/g, ' ')
            .trim()
        : ''
      const motherName = motherData
        ? `${motherData.firstName} ${motherData.middleName ?? ''} ${motherData.surname}`
            .replace(/\s+/g, ' ')
            .trim()
        : ''
          ...
          <View style={{ flexDirection: 'row', gap: 8 }}>
            ...
            <TouchableOpacity
              style={{
                ...
                opacity: isNINComplete(nid) ? 1 : 0.4,
              }}
              onPress={() => lookupParent(nid.toUpperCase(), role)}
      ...
      >
        ...
        >
          ...
          <View style={{ flex: 1, alignItems: 'center' }}>
            ...
            <Text style={{ fontSize: 9, color: 'rgba(255,255,255,0.60)', marginTop: 2 }}>
              NBS · Births & Deaths Registration Act
            </Text>
          </View>
          <View
            style={{
            ...
            <React.Fragment key={n}>
              <View
                style={{
                  ...
                  borderWidth: 1.5,
                  backgroundColor:
                    n < step ? TZ.green : n === step ? H.primary : 'rgba(255,255,255,0.12)',
                  borderColor: n === step ? H.primaryL : 'transparent',
                }}
              >
                {n < step ? (
                  ...
                  <Text
                    style={{
                      fontSize: 10,
                      fontWeight: '700',
                      color: n === step ? '#fff' : 'rgba(255,255,255,0.40)',
                    }}
                  >
                    {n}
                  </Text>
        ...
        >
          {STEP_LABELS.map((l, i) => (
            <Text
              ...
              style={{
                fontSize: 9,
                color: i + 1 === step ? H.primaryL : 'rgba(255,255,255,0.45)',
                width: (W - 32) / 4,
                textAlign: 'center',
              }}
            >
        ...
        >
          ...
          {step === 3 && (
            <View style={{ gap: 14 }}>
              ...
              <Text style={{ fontSize: 12, color: T.textSub, lineHeight: 18 }}>
                Details will appear exactly as on the birth certificate. Surname and middle name are
                pre-filled from father's record.
              </Text>
              {[
                {
                  label: 'First Name *',
                  val: childFirst,
                  setVal: setChildFirst,
                  placeholder: 'e.g. Amani',
                },
                {
                  label: 'Middle Name (from father)',
                  val: childMiddle,
                  setVal: setChildMiddle,
                  placeholder: fatherData?.middleName ?? 'Optional',
                },
                {
                  label: 'Surname * (from father)',
                  val: childSurname,
                  setVal: setChildSurname,
                  placeholder: fatherData?.surname ?? 'e.g. Makonde',
                },
                  ...
                  {(['MALE', 'FEMALE'] as const).map((g) => (
                    <TouchableOpacity
                      ...
                      style={{
                        ...
                        paddingVertical: 12,
                        borderColor:
                          childGender === g ? (g === 'MALE' ? H.primaryL : '#a78bfa') : T.border,
                        backgroundColor:
                          childGender === g
                            ? g === 'MALE'
                              ? `${H.primary}25`
                    ...
                    >
                      ...
                      <Text
                        style={{
                          ...
                          fontWeight: '600',
                          color:
                            childGender === g ? (g === 'MALE' ? H.primaryL : '#c4b5fd') : T.textSub,
                        }}
                      >
                        {g}
                      </Text>
          ...
          {step === 4 && (
            <View style={{ gap: 12 }}>
              ...
              <Text style={{ fontSize: 12, color: T.textSub, lineHeight: 18 }}>
                Verify all details. This record will be permanently stored.
              </Text>
              {fatherData && (
                <View
                  style={{
                    borderRadius: 12,
                    borderWidth: 1,
                    borderColor: `${H.primary}40`,
                    backgroundColor: `${H.primary}08`,
                    padding: 14,
                  }}
                >
                  <Text
                    style={{ fontSize: 12, fontWeight: '800', color: H.primaryL, marginBottom: 8 }}
                  >
                    FATHER
                  </Text>
                  {[
                    [
                      'Full Name',
                      `${fatherData.firstName} ${fatherData.middleName ?? ''} ${fatherData.surname}`.trim(),
                    ],
                    ['National ID', fatherData.nationalId],
                  ].map(([k, v]) => (
                    <View
                      key={k}
                      style={{
                    ...
                    >
                      ...
                      <Text style={{ fontSize: 11, color: T.text, fontWeight: '600' }}>{v}</Text>
                    </View>
                  ))}
                </View>
              )}
              {motherData && (
                ...
                >
                  <Text
                    style={{ fontSize: 12, fontWeight: '800', color: '#c4b5fd', marginBottom: 8 }}
                  >
                    MOTHER
                  </Text>
                  {[
                    [
                      'Full Name',
                      `${motherData.firstName} ${motherData.middleName ?? ''} ${motherData.surname}`.trim(),
                    ],
                    ['National ID', motherData.nationalId],
                  ].map(([k, v]) => (
                    <View
                      key={k}
                      style={{
              ...
              >
                <Text style={{ fontSize: 12, fontWeight: '800', color: TZ.green, marginBottom: 8 }}>
                  NEWBORN
                </Text>
                {[
                  ['Full Name', [childFirst, childMiddle, childSurname].filter(Boolean).join(' ')],
                  ['Gender', childGender],
              ...
              >
                ...
                >
                  I, the registering officer, certify that the information provided is accurate and
                  complete to the best of my knowledge, as required under the Births and Deaths
          ...
          <View style={{ flexDirection: 'row', gap: 10 }}>
            {step > 1 && (
              ...
              >
                ...
                <Text style={{ fontSize: 14, color: T.textSub, fontWeight: '600' }}>Back</Text>
              </TouchableOpacity>
            )}
            {step < 4 ? (
              <TouchableOpacity
