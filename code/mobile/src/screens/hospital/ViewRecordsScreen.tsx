    ...
    async (silent = false) => {
      ...
      const localRows: DisplayRecord[] = [
        ...localBirths.map((b) => ({
          ...
          type: 'birth' as const,
          certNo: b.certNo,
          name: [b.childFirstName, b.childMiddleName, b.childSurname]
            .filter(Boolean)
            .join(' ')
            .toUpperCase(),
    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: T.bg }} edges={['top']}>
      ...
      {offline && (
        <View
          style={[
            s.offlineBanner,
            { backgroundColor: '#f9731618', borderBottomColor: '#f9731640' },
          ]}
        >
      ...
      <View style={[s.searchBar, { backgroundColor: T.card, borderBottomColor: T.border }]}>
        <View style={[s.searchInput, { backgroundColor: T.card2, borderColor: T.border }]}>
          ...
          <TextInput
            style={{ flex: 1, color: T.text, marginLeft: 8, fontSize: 13 }}
            value={query}
      ...
      <View style={[s.filterBar, { backgroundColor: T.card, borderBottomColor: T.border }]}>
        {(
          ...
          <TouchableOpacity
            ...
            style={[
              s.filterTab,
              filter === f && { borderBottomWidth: 2, borderBottomColor: T.primary },
            ]}
            onPress={() => setFilter(f)}
          >
          ...
          ListEmptyComponent={
            <View style={{ alignItems: 'center', paddingTop: 60, gap: 12 }}>
              ...
              <Text style={{ color: T.textDim, fontSize: 12, textAlign: 'center' }}>
                {offline
                  ? 'No local records. Register a birth or death to get started.'
